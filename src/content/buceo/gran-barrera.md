...
visibilidad_min: 10
visibilidad_max: 40
corrientes: "generalmente suaves (mas fuertes en pasos del arrecife exterior)"
certificacion_minima: "OWD (AOWD para paredes profundas y Cod Hole)"
temporada_inicio: "todo el ano"
temporada_mejor: "junio-noviembre"
nivel_recomendado: [principiante, intermedio, avanzado, experto]
highlights:
  - "Patrimonio de la Humanidad UNESCO — mayor sistema de arrecifes del planeta"
  - "2.300 km de extension, 2.900+ arrecifes individuales"
  - "1.500+ especies de peces, 400+ especies de coral"
  - "Encuentros con ballenas minke (junio-julio)"
  - "SS Yongala — uno de los mejores pecios del mundo"
liveaboards:
...
precio_liveaboard: "250-400 AUD/dia"
precio_daytrip: "200-280 AUD/dia"
proveedores_scibasku: ["Mike Ball", "Sunlover", "Fitzroy Island", "Lizard Island"]
...
> Australia · Queensland · 2.300 km · Patrimonio UNESCO
...
| **Fitzroy Island Resort** | Cairns (45 min ferry) | Isla + arrecife | Partner Scibasku |
| **Lizard Island Resort** | Vuelo desde Cairns | Resort lujo + buceo | Partner Scibasku (15%) |

Rango de precios day trip: 200-280 AUD por persona, inmersiones incluidas.
...
- **Principiante (OWD):** Agincourt Reef, Fitzroy Island, la mayoria de day trips al arrecife exterior.
- **Intermedio (AOWD):** Ribbon Reefs, inmersiones profundas, Osprey Reef.
- **Avanzado:** SS Yongala (corrientes), Cod Hole (profundidad), North Horn shark feed.
- **Experto:** Inmersiones nocturnas en Osprey, corrientes fuertes en pasos exteriores.

La Gran Barrera tiene sitios para todos los niveles. Un buceador recien certificado puede disfrutar enormemente de un day trip, y un buceador con 500 inmersiones encontrara en Osprey Reef y el Yongala retos de primer nivel mundial.
...
<!-- JSON-LD se genera en fase de publicacion -->
<!--
{
  "@context": "https://schema.org",
  "@type": "TouristDestination",
  "name": "Gran Barrera de Coral",
  "alternateName": "Great Barrier Reef",
  "description": "El mayor sistema de arrecifes del planeta. 2.300 km, 2.900+ arrecifes, Patrimonio UNESCO. Destino de buceo de clase mundial.",
  "geo": {
    "@type": "GeoCoordinates",
    "latitude": -16.5,
    "longitude": 145.75
