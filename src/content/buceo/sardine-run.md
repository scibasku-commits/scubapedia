---
title: "Sardine Run — Wild Coast, Sudáfrica"
type: destino-buceo
...
profundidad_min: 0
profundidad_max: 20
visibilidad_media: "5–15m (buceo de acción, no de postal)"
temperatura_agua_min: 16
temperatura_agua_max: 21
corrientes: "Atlántico/Índico abierto; condiciones variables, mar a menudo movido"
temporada_alta: "Mayo a Julio (pico en Junio)"
temporada_baja: "Agosto a Abril (fuera de temporada del evento)"
certificacion_minima: "AOWD recomendado"
vida_marina_destacada:
  - "Bait balls de sardinas (Sardinops sagax)"
  - "Delfines comunes (Delphinus delphis) en miles"
  - "Tiburón de cobre (Carcharhinus brachyurus)"
  - "Tiburón oscuro / dusky (Carcharhinus obscurus)"
  - "Tiburón toro (Carcharhinus leucas)"
  - "Tiburón tigre (Galeocerdo cuvier)"
  - "Ballenas jorobadas (Megaptera novaeangliae)"
  - "Gannets y aves marinas"
liveaboards_disponibles:
  - "No hay liveaboard clásico; formato lodge + zodiac 5–7 días"
centros_buceo_recomendados:
  - "Operadores especializados en Wild Coast (vía lodges en Cintsa y Port St. Johns)"
...
# Sardine Run — Wild Coast, Sudáfrica
...
| Dato | Valor |
|------|-------|
| Profundidad | 0m – 20m (trabajo principalmente en superficie) |
| Visibilidad | 5–15m (variable; el plancton que atrae a las sardinas la reduce) |
| Temperatura agua | 16°C – 21°C (Wild Coast) |
| Corrientes | Mar abierto, condiciones variables; a menudo movido |
| Certificación mínima | AOWD recomendado |
| Temporada del evento | Mayo – Julio (pico en Junio) |
