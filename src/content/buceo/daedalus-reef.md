...
vida_marina_destacada:
  - "Tiburon martillo (bancos en estaciones de limpieza)"
  - "Tiburon gris de arrecife"
  - "Tiburon de punta plateada (silvertip)"
  - "Tiburon zorro (raro)"
  - "Atunes"
  - "Barracudas (bancos grandes)"
  - "Jureles gigantes"
  - "Manta raya (estacional)"
...
Excelente para derivas controladas cuando la corriente es lateral. Gorgonias grandes, bancos de barracudas y jureles. Posibilidad de encuentros con tiburones zorro, aunque son raros.
...
Daedalus solo se bucea desde vida a bordo. Normalmente se combina con Brothers y/o Elphinstone en safaris de 7 noches, o con la ruta Deep South (Rocky Island, Zabargad, St. Johns).

### Proveedores Scibasku (reserva directa, mejores condiciones)

| Flota | Barcos | Rango precio safari | Notas |
|-------|--------|---------------------|-------|
| **Golden Dolphin** | I, III, IV | Desde 895 EUR (GD III) | Flota egipcia de confianza. GD I (1.048 EUR), GD IV (1.399 EUR). Tripulacion excelente. |
| **Sea Serpent** | Contessa, Grand, Excellence | Desde 895 EUR | Contessa opcion economica con calidad. Grand y Excellence gama media-alta (1.409 EUR). |
| **Emperor** | Elite, Echo, Asmaa | Desde 1.000 EUR | Estandares britanicos. Buenos briefings, seguridad impecable. Elite (1.295 EUR). |
...
- **Condicion fisica**: Entradas en negativo, corrientes, y a veces nado contra corriente para volver al barco.

Si todavia no tienes 50 inmersiones, haz primero un safari norte ([[safaga-hurghada-norte]]) para coger rodaje. Daedalus te esperara.
...
```json
{
  ...
  "name": "Daedalus Reef",
  "description": "Arrecife oceanico aislado en el Mar Rojo central egipcio, famoso por sus estaciones de limpieza de tiburones martillo y paredes verticales que caen a mas de 300 metros. Solo accesible en liveaboard.",
  "geo": {
    "@type": "GeoCoordinates",
    "latitude": 24.9167,
    "longitude": 35.5333
