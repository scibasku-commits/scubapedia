---
title: "Maldivas — Atolones del Norte"
type: destino-buceo
region: "Maldivas"
pais: "Maldivas"
puntos_inmersion_principales:
  - "Hanifaru Bay (Baa)"
  - "Lankan Manta Point (Male Norte)"
  - "Banana Reef (Male Norte)"
  - "Okobe Thila (Male Norte)"
  - "Maldives Victory Wreck (Male Norte)"
  - "Kuda Rah Thila (Ari Sur)"
  - "Broken Rock (Ari Sur)"
  - "Dhigurah Channel (Ari Sur)"
  - "Rasdhoo Madivaru (Rasdhoo)"
  - "Sola Corner (Lhaviyani)"
  - "Labyrinth (Raa)"
profundidad_min: 5
profundidad_max: 40
visibilidad_media: "20-25m (mejor en temporada seca)"
temperatura_agua_min: 26
temperatura_agua_max: 30
corrientes: "Fuertes en kandus (canales) — AOWD recomendado"
temporada_alta: "Diciembre a Abril (monzon NE — seco, mejor visibilidad)"
temporada_baja: "Mayo a Octubre (monzon SW — mantas y tiburones ballena)"
certificacion_minima: "AOWD (Advanced Open Water Diver)"
vida_marina_destacada:
  - "Mantas de arrecife (concentraciones masivas en Hanifaru Bay)"
  - "Tiburones ballena (todo el año en Ari Sur)"
  - "Tiburones martillo (Rasdhoo, al amanecer)"
  - "15 especies de tiburones (Raa, Lhaviyani)"
  - "Tiburones grises de arrecife"
  - "Napoleones"
  - "Tortugas carey y verde"
  - "Rayas aguila"
  - "Morenas gigantes"
  - "Bancos de fusileros y jureles"
...
centros_buceo_recomendados:
  ...
  - "Dive Butler (Ritz-Carlton Fari, Amilla)"
  - "Kuramathi PADI 5-Star"
  - "Four Seasons Diving (Kuda Huraa, Landaa Giraavaru)"
  - "Prodivers (multiples resorts)"
...
- **Rayas aguila** — En los kandus con corriente.
- **Vida de arrecife** — Corales blandos espectaculares, especialmente en overhangs y cuevas. Nudibranquios, peces hoja, peces rana para los amantes del macro.

## Desde resort vs liveaboard

### Resort con centro de buceo
...
| Objetivo | Meses |
|----------|-------|
| Mantas (Hanifaru Bay) | Junio - Octubre |
| Tiburones ballena (Ari) | Todo el año (pico sep-nov) |
| Tiburones martillo (Rasdhoo) | Noviembre - Abril |
| Mejor visibilidad | Enero - Abril |
| Mejor precio | Mayo - Julio |
