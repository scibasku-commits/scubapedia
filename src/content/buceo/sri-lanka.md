...
puntos_inmersion_principales:
  ...
  - "Little Basses Reef (sur)"
  - "Dutch Bay (Kalpitiya — tiburón ballena)"
  - "Hikkaduwa Reef"
profundidad_min: 5
profundidad_max: 50
visibilidad_media: "10-25m (variable por región y temporada)"
temperatura_agua_min: 26
temperatura_agua_max: 30
corrientes: "variables; Great/Little Basses tienen corrientes fuertes estacionales; Pigeon Island tranquila"
temporada_alta: "diciembre a abril (costa suroeste y sur); mayo a septiembre (costa noreste — Trincomalee)"
temporada_baja: "depende de la costa; Sri Lanka tiene dos temporadas según el monzón (SW y NE)"
certificacion_minima: "OW (Pigeon Island, Hikkaduwa); AOWD (HMS Hermes, Basses Reef)"
vida_marina_destacada:
  - "Ballena azul (Balaenoptera musculus) — Mirissa; mayor concentración global accesible"
  - "Ballena de Bryde (Balaenoptera edeni)"
  - "Tiburón ballena (Rhincodon typus) — Kalpitiya, feb-mar"
  - "Manta del Océano Índico (Mobula birostris)"
  - "Tortuga carey, tortuga verde, tortuga olivácea"
  - "Tiburón de arrecife de punta blanca"
  - "Dugongo (Dugong dugon) — Bar Reef, Kalpitiya"
  - "Barracuda (banco)"
  - "HMS Hermes — portaaviones WWII completo"
liveaboards_disponibles:
  - "Liveaboard charters desde Trincomalee (temporada)"
centros_buceo_recomendados:
  - "Nilaveli Diving (Trincomalee)"
  - "Poseidon Diving (Negombo)"
  - "Kalpitiya Diving"
  - "Dive Lanka"
proveedores_scibasku: []
precio_semana_aprox: "600-1.400 USD (resort con paquete buceo 7 noches; más vuelos domésticos entre costas)"
giora_estuvo: false
updated: 2026-06-14
status: draft
tags:
