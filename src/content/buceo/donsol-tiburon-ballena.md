---
title: "Donsol — Tiburón ballena"
type: destino-buceo
region: "Luzón Sur / Filipinas"
pais: "Filipinas"
...
profundidad_min: 3
profundidad_max: 30
visibilidad_media: "5-20m en Donsol Bay (plancton que atrae a los tiburones); 15-25m en Ticao Pass"
temperatura_agua_min: 26
temperatura_agua_max: 29
corrientes: "fuertes en Ticao Pass; sin corriente en Donsol Bay (zona costera)"
temporada_alta: "noviembre a junio (tiburón ballena; pico feb-may); julio a diciembre (mantas en Manta Bowl)"
temporada_baja: "julio a octubre (monzón en Donsol; sin tiburón ballena; mantas continúan)"
certificacion_minima: "OW (Ticao Pass); snorkel o no-buceador (tiburón ballena en Donsol)"
vida_marina_destacada:
  - "Tiburón ballena (Rhincodon typus) — Donsol Bay; el avistamiento en estado más salvaje del mundo"
  - "Manta de arrecife (Mobula alfredi) — Manta Bowl; agregaciones de 50+ en temporada"
  - "Manta oceánica (Mobula birostris)"
  - "Tiburón de punta blanca de arrecife (Ticao Pass)"
  - "Tiburón de arrecife gris (Ticao Pass)"
  - "Mantarraya de cola corta (Himantura fai)"
liveaboards_disponibles: []
centros_buceo_recomendados:
  - "WWF Donsol Interaction Officers (coordinación tiburón ballena)"
  - "Pintuyan Dive Center (tiburones ballena + Ticao)"
  - "Donsol Whaleshark Interaction"
proveedores_scibasku: []
precio_semana_aprox: "300-600 USD (alojamiento básico-medio + excursiones; Donsol es muy económico)"
giora_estuvo: false
updated: 2026-06-15
status: draft
tags:
...
# Donsol — Tiburón ballena

> Filipinas · Luzón Sur · El mayor avistamiento de tiburón ballena en estado salvaje del mundo — sin condicionamiento, sin comida, solo plancton y océano
...
Contiguo a Donsol, en el paso de Ticao, uno de los puntos de mantas más densos de Filipinas completa el destino.

## Datos técnicos

| Dato | Valor |
|------|-------|
| Tipo de interacción | Snorkel (tiburón ballena); buceo (Ticao Pass + Manta Bowl) |
| Profundidad buceo | 3m - 30m |
| Visibilidad | 5-20m en Donsol Bay; 15-25m en Ticao |
| Temperatura del agua | 26-29°C |
| Certificación mínima | Saber nadar (Donsol); OW (Ticao Pass) |
...
1. Briefing obligatorio del WWF antes de cada salida (30 minutos)
2. Máximo 6 personas por tiburón simultáneamente. El "Interaction Officer" (guía de WWF) controla el acceso
3. Solo snorkel — las aletas quedan en el bote cuando estás con el tiburón
4. Distancia mínima: 3 metros del cuerpo, 4 metros de la cola
5. Sin flash fotográfico
6. Sin tocar
7. Si el tiburón se aleja, no se persigue
...
| Tramo | Detalle |
|-------|---------|
| Vuelo | Madrid → Manila (MNL) → Legazpi (LGP), vuelo doméstico 1h15; o Manila → bus a Donsol (~9h) |
| Transfer a Donsol | Legazpi → Donsol, 1h en coche |
| Total | ~22-26h puerta a puerta en vuelo; más si es bus |

**Visado:** Filipinas — ciudadanos españoles sin visado hasta 30 días.

**Nota:** El aeropuerto de Legazpi (Albay) es pequeño con vuelos desde Manila relativamente frecuentes. El bus Manila-Donsol es la opción local más económica.
...
- [[malapascua]] — El tiburón zorro; a 4h de vuelo al norte
- [[dumaguete]] — El muck diving y Apo Island; Visayas Sur
- [[isla-mujeres]] — El tiburón ballena del Caribe; diferente escala
- [[similan-surin-richelieu]] — El tiburón ballena del Andamán; en liveaboard

## Fuentes

- [WWF Philippines — Donsol](https://www.wwf.org.ph/what-we-do/marine/donsol/) — Programa de interacción; protocolo oficial y estadísticas de avistamiento
- [Pintuyan Dive Center Donsol](https://www.pintuyan.com/) — Operador de referencia; buceo Ticao Pass + tiburón ballena
- [Manta Trust — Philippines](https://www.mantatrust.org/) — Base de datos de mantas de Manta Bowl; fotos-ID e investigación
- [Philippine Tourism Authority — Sorsogon](https://www.tourism.gov.ph/) — Regulación y temporadas oficiales
