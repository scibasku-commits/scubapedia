---
title: "Mar Rojo Norte — Dahab y Ras Mohammed"
type: destino-buceo
region: "Mar Rojo / Egipto"
pais: "Egipto"
puntos_inmersion_principales:
  - "Blue Hole (Dahab)"
  - "The Bell — Blue Hole"
  - "The Lighthouse (Dahab)"
  - "Ras Abu Galum"
  - "Canyon (Dahab)"
  - "Ras Mohammed — Shark Reef & Yolanda"
  - "Ras Mohammed — Jolanda Reef"
  - "Tower (Dahab)"
profundidad_min: 5
profundidad_max: 100
visibilidad_media: "20-40m (Mar Rojo norte tiene vis excepcional)"
temperatura_agua_min: 20
temperatura_agua_max: 28
corrientes: "leves en la mayoría de sitios de Dahab; fuertes en Ras Mohammed y Jolanda; Blue Hole sin corriente"
temporada_alta: "octubre a mayo (temperatura ideal; menos calor)"
temporada_baja: "junio a septiembre (calor extremo en tierra 40°C+; el buceo en sí es excelente)"
certificacion_minima: "OW (Lighthouse, Tower, Ras Mohammed exterior); Advanced y Tec para Blue Hole profundo"
vida_marina_destacada:
  - "Napoleón (Cheilinus undulatus) — presencia constante en Ras Mohammed"
  - "Tiburón martillo (Sphyrna lewini) — Ras Mohammed y puntos profundos Dahab"
  - "Tiburón oceánico de punta blanca (Carcharhinus longimanus)"
  - "Barracuda (banco masivo en Jolanda Reef)"
  - "Pez globo gigante (Diodon hystrix)"
  - "Murena gigante (Gymnothorax javanicus)"
  - "Leon fish (Pterois miles)"
  - "Tortuga carey"
  - "Rayas de fondo"
liveaboards_disponibles:
  - "Múltiples liveaboards desde Hurghada y Sharm hacia sur"
centros_buceo_recomendados:
  - "Dive Tribe Dahab"
  - "Nesima Dive Center (Dahab)"
  - "Sinai Divers (Dahab)"
  - "Camel Dive Club (Sharm el-Sheikh)"
proveedores_scibasku: []
precio_semana_aprox: "300-650 EUR (resort + paquete buceo 7 noches en Dahab; el destino más asequible de esta guía)"
giora_estuvo: false
updated: 2026-06-14
status: draft
tags:
...
# Mar Rojo Norte — Dahab y Ras Mohammed

> Egipto · El Blue Hole más famoso del mundo, el Parque Nacional marino más visitado del Mar Rojo, y el destino de buceo más barato del hemisferio con este nivel de calidad

## Resumen

Dahab tiene fama de dos cosas: ser el destino de buceo más barato del mundo con esta calidad submarina, y albergar el Blue Hole — el sumidero oceánico de 130 metros de profundidad y paredes verticales de coral que ha costado la vida a más buceadores que cualquier otro punto recreativo del mundo, precisamente porque lo visitan buceadores que no deberían visitarlo.

Esa dualidad define el Mar Rojo Norte. La misma franja de agua que tiene el Blue Hole — accesible a todo el mundo desde la orilla, con un café a 20 metros — tiene también el Parque Nacional de Ras Mohammed, donde la esquina entre el Golfo de Suez y el Golfo de Aqaba crea corriente que concentra bancos de barracudas de cientos de individuos, napoleones de metro y medio, y tiburones oceánicos que en el resto del Mar Rojo han desaparecido por la sobrepesca.
...
| Dato | Valor |
|------|-------|
| Profundidad | 5m (sandy beach entry) - 100m+ (Blue Hole) |
| Visibilidad | 20-40m |
| Temperatura del agua | 20-28°C (20°C en enero; 28°C en verano) |
| Corrientes | Sin corriente en mayoría de Dahab; fuerte en Ras Mohammed |
| Certificación | OW para 90% del buceo; Tec para Blue Hole por debajo de 40m |
| Tipo de buceo | Arrecife coralino, pared vertical, wreck, pelágicos |
...
| Tramo | Detalle |
|-------|---------|
| Vuelo directo | Madrid → Sharm el-Sheikh (SSH), ~4h30: charter o regular (Iberia, Vueling, Ryanair en temporada) |
| Transfer a Dahab | Sharm el-Sheikh → Dahab, 90 min en taxi colectivo o bus (~8-15 EUR) |

**Base recomendada:** Dahab para presupuesto y ambiente local auténtico. Sharm el-Sheikh para resort todo incluido con mayor infraestructura.

**Visado:** Egipto — visa on arrival para españoles en el aeropuerto, 25 USD. También disponible online (e-Visa).

## Mejor época para ir

- **Octubre - Diciembre:** La ventana óptima europea. Temperatura en tierra bajando (25-30°C), agua aún cálida (26-28°C), menos turismo masivo que verano.
- **Enero - Marzo:** Agua fría (20-22°C), traje 5mm. La vis es máxima. Los tiburones oceánicos más activos en Ras Mohammed.
- **Abril - Mayo:** Cálido y con buena vis. Temporada intermedia.
- **Junio - Septiembre:** Calor extremo en tierra (40-45°C). El buceo es excelente pero salir del agua hace calor. Temporada de familias y precios altos en los resorts de Sharm.

## Consejo Scibasku

Dahab es el destino que recomendamos para el buceador que quiere el primer gran viaje con temperatura del agua cálida y arrecife tropical sin meterse en un vuelo de 14 horas ni gastar 2.000 EUR. El coste total de una semana en Dahab — vuelo + resort modesto + paquete de buceo — puede estar por debajo de 600 EUR por persona en temporada baja.

La trampa del Blue Hole: muchos buceadores OW que llegan por el Blue Hole no se quedan en los 30m superficiales donde el buceo es excelente. No presentar el Arch como algo que hay que cruzar — es territorio técnico y está claramente señalizado.

La combinación perfecta: **5 noches Dahab** (Blue Hole exterior, Lighthouse, Canyon) + **1 día excursión Ras Mohammed** desde Dahab en barco.
