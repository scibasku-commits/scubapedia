...
corrientes: "Leves en shore dives; moderadas a fuertes en Pescador Island"
temporada_alta: "Noviembre a Mayo (temporada seca)"
temporada_baja: "Junio a Octubre (lluvias, sardinas siguen presentes)"
certificacion_minima: "OWD"
vida_marina_destacada:
  - "Sardinas (banco residente masivo, millones de individuos)"
  - "Tortugas verdes y carey (residentes)"
  - "Serpientes marinas (banded sea krait)"
  - "Barracudas y jureles"
  - "Nudibranquios"
...
> Millones de sardinas formando un muro vivo a metros de la orilla, todos los días del año. Sin temporada. Sin migración. Solo Moalboal.

## Resumen

Moalboal, en la costa suroeste de Cebu, alberga un fenómeno único en el mundo del buceo: un sardine run residente permanente. Millones de sardinas (Sardinella spp.) forman un banco masivo frente a Panagsama Beach, presente los 365 días del año. Las corrientes ricas en nutrientes del Estrecho de Tañón traen plancton que mantiene a estos peces congregados a apenas 20-30 metros de la orilla, en aguas de 1 a 10 metros de profundidad. No existe otro lugar en el planeta donde este fenómeno ocurra a esta escala de forma permanente.

Pero Moalboal no es solo sardinas. Pescador Island ofrece paredes verticales espectaculares y la Cathedral Cave, un swim-through vertical donde la luz natural crea un efecto catedral. Tongo Point garantiza tortugas verdes en prácticamente cada inmersión. Los house reefs esconden macro interesante, desde nudibranquios hasta pulpos de anillos azules. Y todo esto a precios entre los más accesibles del buceo mundial.

El formato es resort con dayboat. No hay liveaboard en Moalboal ni es necesario: los mejores puntos de inmersión están a minutos de la costa.

## Datos técnicos

| Dato | Valor |
|------|-------|
| Ubicación | Costa suroeste de Cebu, Visayas, Filipinas |
| Profundidad | 3-40m+ (la mayoría del buceo: 5-25m) |
| Visibilidad | 15-30m+ (mejor nov-may; hasta 50m en Pescador) |
| Temperatura agua | 27-30°C todo el año |
| Corrientes | Leves en shore; moderadas-fuertes en Pescador |
| Certificación mínima | OWD (AOWD para Cathedral Cave, 28m) |
| N.° puntos de inmersión | 17+ documentados |
| Precio por inmersión | 20-35 USD (orientativo) |

## Puntos de inmersión destacados

### Panagsama Beach -- Sardine Run
El motivo por el que vienes a Moalboal. Un banco de millones de sardinas a 20-30 metros de la orilla, entre 1 y 10 metros de profundidad. Accesible como shore dive sin barco. Los jureles y barracudas cazan activamente formando bait balls que cambian de forma a velocidad hipnótica. Mejor temprano por la mañana (5:00-7:00 AM), cuando el banco está más cerca de la orilla y hay menos snorkelistas. También funciona perfectamente en snorkel.

### Pescador Island
Santuario marino a 15 minutos en banca. Pared vertical que cae a más de 40 metros con corales abanico y vida de arrecife densa. La Cathedral Cave es el highlight: entrada a ~28m, chimenea vertical que sube hasta ~16m donde la luz natural entra desde arriba creando un efecto dramático. Tortugas, serpientes marinas, barracudas. La inmersión más completa y técnicamente exigente de la zona.
...
Vuelo internacional a **Cebu (CEB)**, aeropuerto Mactan-Cebu. Desde el aeropuerto, transporte terrestre a Moalboal: 3-3,5 horas por carretera. Opciones: bus desde South Bus Terminal de Cebu City (~3h, económico) o transfer privado organizado por el resort. Visado UE: exención automática hasta 30 días.

## Nivel requerido

**OWD es suficiente** para el sardine run, Tongo Point, White Beach y la mayoría de shore dives. **AOWD recomendado** para Pescador Island profundo y Cathedral Cave (entrada a 28m). Snorkelistas sin certificación pueden disfrutar plenamente del sardine run. Lo que importa en Moalboal no es el nivel de certificación sino la **flotabilidad**: no tocar el fondo, no hacer movimientos bruscos que dispersen a las sardinas.
