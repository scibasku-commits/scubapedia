...
export function normalizeZona(r: string): string {
  if (!r) return 'Otros';
...
export function zonaSlug(z: string): string {
...
export function zonaRank(z: string): number {
...
const ZONA_BLURB: Record<string, string> = {
...
export function zonaBlurb(z: string): string {
...
const ZONA_GRADIENT: Record<string, string> = {
...
export function zonaGradient(z: string): string {
